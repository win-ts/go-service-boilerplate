...
// AMQPProducerRepository represents the repository layer functions of AMQP producer repository
type AMQPProducerRepository interface {
	ProduceJSONMessage(ctx context.Context, event dto.Event) error
}
