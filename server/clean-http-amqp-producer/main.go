...
import (
	...
	"github.com/win-ts/go-service-boilerplate/server/clean-http-amqp-producer/di"
	_ "github.com/win-ts/go-service-boilerplate/server/clean-http-amqp-producer/docs"
)
